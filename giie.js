        ...
        if (!mek.key.remoteJid.endsWith('@g.us') && offline) {
            if (!mek.key.fromMe) {
                ...
                buttons = [{
                                        ...
                                        buttonText: {
                                            displayText: `Hai
aku ${pushname}, kamu lagi sibuk ya ? aku cuma mau bilang kalau aku tuh selama ini memendam perasaan sama kamu 😔, jujur aku gak kuat jika harus dipendam ini semua sendirian 🙍‍♂️, ketika mata ini memandang raut wajahmu yang indah, hanya tiga kata yang terucap dari lubuk hatiku yang paling dalam, aku cinta kamu echa 🥰,
...
*Chapter Akhir* : ${komik.chapter_akhir}`
            ...
            case 'giie':
                buttonss = [{
                    buttonId: `${prefix}igstalk giiexsala`,
                    buttonText: {
...
▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒`, MessageType.extendedText, {
            ...
            case 'tiktokdownload':
                ...
                buttons = [{
                    buttonId: `${prefix}ttwm ${srch}`,
                    buttonText: {
                        displayText: 'WM'
                    },
                    type: 1
                }, {
                    buttonId: `${prefix}ttnowm ${srch}`,
                    buttonText: {
                        displayText: 'NO WM'
                    },
                    type: 1
...
`
            ...
            case 'antidelete':
                ...
                if (!isGroupAdmins) return reply(mess.only.admin)
                if (!isBotGroupAdmins) return reply(mess.only.Badmin)
                if (args.length < 1) return reply('!antidelete on/off')
                if ((args[0]) === 'on') {
                        ...
                        .then((res) => {
                            ...
                            axios.get(`https://tinyurl.com/api-create.php?url=${dl_link}`)
                                .then(async (a) => {
                                    ...
                                    buttons = [{
                                        buttonId: `${prefix}audio ${srch}`,
                                        buttonText: {
                                            displayText: 'MP3'
                                        },
                                        type: 1
                                    }, {
                                        buttonId: `${prefix}video ${srch}`,
                                        buttonText: {
                                            displayText: 'MP4'
                                        },
                                        type: 1
